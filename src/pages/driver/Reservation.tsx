    ...
    <div className="min-h-screen">
      ...
      <div className="container mx-auto px-6 max-w-7xl pb-8">
        <div className="grid lg:grid-cols-3 gap-8">
          {/* Left Column - Stations List + Calendar/Time */}
          <div className="lg:col-span-2 space-y-6">
              ...
              {stations.map((station) => {
                ...
                return (
                  <Card 
                    ...
                    className={`border-0 shadow-xl bg-white/90 backdrop-blur-sm animate-fade-in transition-all duration-300 cursor-pointer hover:scale-[1.01] ${
            ...
            {/* Calendar & Time Selection - Fixed Position */}
            {activeStation && (
              <Card className="border-0 shadow-xl bg-white/90 backdrop-blur-sm animate-fade-in">
                ...
                <CardHeader>
                  <CardTitle className="flex items-center text-xl font-bold text-gray-800">
                    ...
                    Đặt lịch cho {stations.find(s => s.id === activeStation)?.name}
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex justify-center bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-4">
                      <Calendar
                        mode="single"
                        selected={getReservation(activeStation)?.date}
                        onSelect={(date) => updateReservation(activeStation, date)}
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {timeSlots.map((time) => {
                        const reservation = getReservation(activeStation);
                        return (
                          <Button
                            key={time}
                            variant={reservation?.time === time ? "default" : "outline"}
                            onClick={() => updateReservation(activeStation, undefined, time)}
