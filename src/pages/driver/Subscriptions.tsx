          ...
          <div className="grid md:grid-cols-3 gap-8">
            {packages.map((pkg, index) => {
              ...
              return (
                <Card 
                  key={pkg.id} 
                  className={`relative border-0 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden group ${
                ...
                >
                  ...
                  <CardContent className="px-6 pb-8">
                    ...
                    <Button 
                      className={`w-full h-12 text-lg font-semibold rounded-xl transition-all duration-300 hover:scale-105 shadow-lg ${
                        pkg.popular 
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                ...
                <div key={index} className="flex justify-between items-center p-6 bg-gray-50 rounded-2xl hover:bg-gray-100 transition-colors group">
